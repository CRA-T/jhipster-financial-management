...
import static com.crat.budget.domain.ArticleAsserts.*;
...
import com.crat.budget.domain.enumeration.FinancialCategoryEnum;
import com.crat.budget.repository.ArticleRepository;
import com.crat.budget.service.ArticleService;
...
class ArticleResourceIT {
    ...
    void partialUpdateArticleWithPatch() throws Exception {
        ...
        partialUpdatedArticle.code(UPDATED_CODE).accountDiv(UPDATED_ACCOUNT_DIV).paragraph(UPDATED_PARAGRAPH);
