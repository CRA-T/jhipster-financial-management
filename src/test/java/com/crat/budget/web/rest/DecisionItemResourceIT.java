...
import static com.crat.budget.domain.DecisionItemAsserts.*;
import static com.crat.budget.web.rest.TestUtil.createUpdateProxyForBean;
import static com.crat.budget.web.rest.TestUtil.sameNumber;
...
class DecisionItemResourceIT {
    ...
    void partialUpdateDecisionItemWithPatch() throws Exception {
        ...
        partialUpdatedDecisionItem.beneficiary(UPDATED_BENEFICIARY).amount(UPDATED_AMOUNT);
