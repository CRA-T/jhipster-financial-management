...
import static com.crat.budget.domain.RecipeAsserts.*;
...
class RecipeResourceIT {
    ...
    void partialUpdateRecipeWithPatch() throws Exception {
        ...
        partialUpdatedRecipe.achievementsInThePastYear(UPDATED_ACHIEVEMENTS_IN_THE_PAST_YEAR).newYearForecast(UPDATED_NEW_YEAR_FORECAST);
