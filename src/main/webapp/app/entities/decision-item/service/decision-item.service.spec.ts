...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../decision-item.test-samples';
...
describe('DecisionItem Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a DecisionItem', () => {
      ...
      service.create(decisionItem).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a DecisionItem', () => {
      ...
      service.update(decisionItem).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addDecisionItemToCollectionIfMissing', () => {
      it('should add a DecisionItem to an empty array', () => {
        ...
        expectedResult = service.addDecisionItemToCollectionIfMissing([], decisionItem);
      ...
      it('should not add a DecisionItem to an array that contains it', () => {
        ...
        expectedResult = service.addDecisionItemToCollectionIfMissing(decisionItemCollection, decisionItem);
      ...
      it('should add only unique DecisionItem to an array', () => {
        const decisionItemArray: IDecisionItem[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const decisionItemCollection: IDecisionItem[] = [sampleWithRequiredData];
        expectedResult = service.addDecisionItemToCollectionIfMissing(decisionItemCollection, ...decisionItemArray);
      ...
      it('should accept varargs', () => {
        ...
        expectedResult = service.addDecisionItemToCollectionIfMissing([], decisionItem, decisionItem2);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(decisionItem);
      ...
      it('should accept null and undefined values', () => {
        const decisionItem: IDecisionItem = sampleWithRequiredData;
        expectedResult = service.addDecisionItemToCollectionIfMissing([], null, decisionItem, undefined);
        expect(expectedResult).toHaveLength(1);
        expect(expectedResult).toContain(decisionItem);
      });
      ...
      it('should return initial array if no DecisionItem is added', () => {
        const decisionItemCollection: IDecisionItem[] = [sampleWithRequiredData];
        expectedResult = service.addDecisionItemToCollectionIfMissing(decisionItemCollection, undefined, null);
