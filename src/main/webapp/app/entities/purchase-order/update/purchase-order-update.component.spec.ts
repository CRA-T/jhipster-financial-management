...
describe('PurchaseOrder Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    ...
    it('Should call Engagement query and add missing value', () => {
      ...
      const expectedCollection: IEngagement[] = [...additionalEngagements, ...engagementCollection];
      ...
      expect(engagementService.addEngagementToCollectionIfMissing).toHaveBeenCalledWith(
