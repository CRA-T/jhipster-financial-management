...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../engagement.test-samples';
...
describe('Engagement Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Engagement', () => {
      ...
      service.create(engagement).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Engagement', () => {
      ...
      service.update(engagement).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addEngagementToCollectionIfMissing', () => {
      ...
      it('should add only unique Engagement to an array', () => {
        const engagementArray: IEngagement[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
