...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../purchase-order-item.test-samples';
...
describe('PurchaseOrderItem Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a PurchaseOrderItem', () => {
      ...
      service.create(purchaseOrderItem).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a PurchaseOrderItem', () => {
      ...
      service.update(purchaseOrderItem).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addPurchaseOrderItemToCollectionIfMissing', () => {
      ...
      it("should add a PurchaseOrderItem to an array that doesn't contain it", () => {
        const purchaseOrderItem: IPurchaseOrderItem = sampleWithRequiredData;
        const purchaseOrderItemCollection: IPurchaseOrderItem[] = [sampleWithPartialData];
        expectedResult = service.addPurchaseOrderItemToCollectionIfMissing(purchaseOrderItemCollection, purchaseOrderItem);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(purchaseOrderItem);
      });
      ...
      it('should add only unique PurchaseOrderItem to an array', () => {
        const purchaseOrderItemArray: IPurchaseOrderItem[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const purchaseOrderItemCollection: IPurchaseOrderItem[] = [sampleWithRequiredData];
    ...
    describe('comparePurchaseOrderItem', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.comparePurchaseOrderItem(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.comparePurchaseOrderItem(entity1, entity2);
        const compareResult2 = service.comparePurchaseOrderItem(entity2, entity1);
