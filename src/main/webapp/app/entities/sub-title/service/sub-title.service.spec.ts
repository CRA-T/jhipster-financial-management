...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../sub-title.test-samples';
...
describe('SubTitle Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a SubTitle', () => {
      ...
      service.create(subTitle).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a SubTitle', () => {
      ...
      service.update(subTitle).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addSubTitleToCollectionIfMissing', () => {
      ...
      it('should not add a SubTitle to an array that contains it', () => {
        ...
        expectedResult = service.addSubTitleToCollectionIfMissing(subTitleCollection, subTitle);
      ...
      it('should add only unique SubTitle to an array', () => {
        const subTitleArray: ISubTitle[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const subTitleCollection: ISubTitle[] = [sampleWithRequiredData];
        expectedResult = service.addSubTitleToCollectionIfMissing(subTitleCollection, ...subTitleArray);
      ...
      it('should accept varargs', () => {
        ...
        expectedResult = service.addSubTitleToCollectionIfMissing([], subTitle, subTitle2);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(subTitle);
      ...
      it('should accept null and undefined values', () => {
        const subTitle: ISubTitle = sampleWithRequiredData;
        expectedResult = service.addSubTitleToCollectionIfMissing([], null, subTitle, undefined);
        expect(expectedResult).toHaveLength(1);
        expect(expectedResult).toContain(subTitle);
      });
      ...
      it('should return initial array if no SubTitle is added', () => {
        const subTitleCollection: ISubTitle[] = [sampleWithRequiredData];
        expectedResult = service.addSubTitleToCollectionIfMissing(subTitleCollection, undefined, null);
