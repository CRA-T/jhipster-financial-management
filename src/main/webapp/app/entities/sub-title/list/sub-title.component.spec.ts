...
import { sampleWithRequiredData } from '../sub-title.test-samples';
import { SubTitleService } from '../service/sub-title.service';

import { SubTitleComponent } from './sub-title.component';
import SpyInstance = jest.SpyInstance;

describe('SubTitle Management Component', () => {
  let comp: SubTitleComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(SubTitleComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.subTitles()[0]).toEqual(expect.objectContaining({ id: 2895 }));
  });

  describe('trackId', () => {
    it('Should forward to subTitleService', () => {
      const entity = { id: 2895 };
      jest.spyOn(service, 'getSubTitleIdentifier');
      const id = comp.trackId(entity);
      expect(service.getSubTitleIdentifier).toHaveBeenCalledWith(entity);
