...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../annex-decision.test-samples';
...
describe('AnnexDecision Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a AnnexDecision', () => {
      ...
      service.create(annexDecision).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a AnnexDecision', () => {
      ...
      service.update(annexDecision).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addAnnexDecisionToCollectionIfMissing', () => {
      it('should add a AnnexDecision to an empty array', () => {
        ...
        expectedResult = service.addAnnexDecisionToCollectionIfMissing([], annexDecision);
      ...
      it('should not add a AnnexDecision to an array that contains it', () => {
        ...
        expectedResult = service.addAnnexDecisionToCollectionIfMissing(annexDecisionCollection, annexDecision);
        expect(expectedResult).toHaveLength(2);
      });

      it("should add a AnnexDecision to an array that doesn't contain it", () => {
        const annexDecision: IAnnexDecision = sampleWithRequiredData;
        const annexDecisionCollection: IAnnexDecision[] = [sampleWithPartialData];
        expectedResult = service.addAnnexDecisionToCollectionIfMissing(annexDecisionCollection, annexDecision);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(annexDecision);
      });
      ...
      it('should add only unique AnnexDecision to an array', () => {
        const annexDecisionArray: IAnnexDecision[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const annexDecisionCollection: IAnnexDecision[] = [sampleWithRequiredData];
        expectedResult = service.addAnnexDecisionToCollectionIfMissing(annexDecisionCollection, ...annexDecisionArray);
      ...
      it('should accept varargs', () => {
        ...
        expectedResult = service.addAnnexDecisionToCollectionIfMissing([], annexDecision, annexDecision2);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(annexDecision);
      ...
      it('should accept null and undefined values', () => {
        const annexDecision: IAnnexDecision = sampleWithRequiredData;
        expectedResult = service.addAnnexDecisionToCollectionIfMissing([], null, annexDecision, undefined);
        expect(expectedResult).toHaveLength(1);
        expect(expectedResult).toContain(annexDecision);
      });
      ...
      it('should return initial array if no AnnexDecision is added', () => {
        const annexDecisionCollection: IAnnexDecision[] = [sampleWithRequiredData];
        expectedResult = service.addAnnexDecisionToCollectionIfMissing(annexDecisionCollection, undefined, null);
